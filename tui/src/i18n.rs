...
pub enum Msg {
    ...
    ProxyNode,
    ProxyNodePickerHint,
    ProxyNodePickerAutoHint,
    ProxyAutoGroupKeepsChoice,
    ProxyDelayTesting,
    ProxyDelayTimeout,
    ProxyDelayError,
    ProxyNoNodes,
...
fn en(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ConfirmDisableDangerous => "Disable confirmation prompts for dangerous actions?",
        Msg::DialogCloseFirst => "Close the current dialog before opening commands.",
        Msg::SudoPasswordRequired => "Sudo password required",
        Msg::SudoPasswordEmpty => "Sudo password cannot be empty",
        Msg::SettingsSaveFailed => "Save settings failed",
        Msg::ActionCancelled => "Action cancelled",
        ...
        Msg::CommandOutputScrollHint => "Esc: close  Wheel: scroll",
        Msg::HelpKey => "Key",
        Msg::HelpPage => "Page",
        ...
        Msg::ActionsPrimary => "Primary",
        Msg::ActionsEdit => "Edit",
        Msg::ActionsTags => "Tags",
        Msg::ActionsKernel => "Kernel",
        Msg::ActionsProxy => "Proxy",
        Msg::ActionsTun => "TUN",
        Msg::ActionsDesktop => "Desktop",
        ...
        Msg::ProxyTableHint => "Enter:test  o:nodes  d:current  D:all  /:search",
        Msg::ProxyUnknownGroup => "Unknown",
        Msg::ProxyNode => "Node",
        Msg::ProxyNodePickerHint => "Esc:close  Wheel:scroll  Click selected node:switch and test",
        Msg::ProxyNodePickerAutoHint => {
            "Esc:close  Wheel:scroll  Click selected node:test only; core auto-selects"
        }
        Msg::ProxyAutoGroupKeepsChoice => "Automatic group: testing only; core keeps final choice",
        Msg::ProxyDelayTesting => "testing",
        Msg::ProxyDelayTimeout => "timeout",
        Msg::ProxyDelayError => "error",
...
fn en_action_label(action_id: &str) -> Option<&'static str> {
    Some(match action_id {
        ...
        "proxy.node.switch" => "Confirm node",
...
fn en_action_desc(action_id: &str) -> Option<&'static str> {
    Some(match action_id {
        ...
        "settings.ui.mouse" => "Toggle terminal mouse capture immediately.",
        ...
        "proxy.node.switch" => "Confirm the selected node in the node list.",
...
fn zh_action_desc(action_id: &str) -> Option<&'static str> {
    Some(match action_id {
        ...
        "proxy.node.switch" => "在节点详情中确认选中节点。",
...
fn zh(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ConfirmDisableDangerous => "关闭危险操作确认提示？",
        Msg::DialogCloseFirst => "请先关闭当前弹窗再打开命令面板。",
        Msg::SudoPasswordRequired => "需要 sudo 密码",
        Msg::SudoPasswordEmpty => "sudo 密码不能为空",
        Msg::SettingsSaveFailed => "保存设置失败",
        Msg::ActionCancelled => "操作已取消",
        ...
        Msg::CommandOutputScrollHint => "Esc:关闭  滚轮:滚动",
        Msg::HelpKey => "按键",
        Msg::HelpPage => "页面",
        Msg::HelpAction => "动作",
        Msg::HelpRisk => "风险",
        ...
        Msg::ActionsPrimary => "主要",
        Msg::ActionsEdit => "编辑",
        Msg::ActionsTags => "标签",
        Msg::ActionsKernel => "内核",
        Msg::ActionsProxy => "代理",
        Msg::ActionsTun => "TUN",
        Msg::ActionsDesktop => "桌面",
        ...
        Msg::ProxyActions => "操作",
        Msg::ProxyTableHint => "Enter:测速  o:节点  d:当前  D:全测  /:搜索",
        Msg::ProxyUnknownGroup => "未知",
        Msg::ProxyNode => "节点",
        Msg::ProxyNodePickerHint => "Esc:关闭  滚轮:滚动  点击已选节点:切换并测速",
        Msg::ProxyNodePickerAutoHint => "Esc:关闭  滚轮:滚动  点击已选节点:仅测速，核心自动选择",
        Msg::ProxyAutoGroupKeepsChoice => "自动策略组：仅测速，最终节点由核心选择",
        Msg::ProxyDelayTesting => "测试中",
        Msg::ProxyDelayTimeout => "超时",
        Msg::ProxyDelayError => "错误",
